...
import com.asdoi.quicksettings.tiles.SwitchLanguagesTileService;
...
public class SettingsActivity extends AppCompatActivity implements SearchPreferenceResultListener {
    ...
    public static ArrayMap<String, Class<?>> getPreferenceService() {
        ...
        servicePreferences.put("open_language", SwitchLanguagesTileService.class);
    ...
    public static ArrayList<Class<?>> getModifySystemChangeConfigurationServices() {
        ArrayList<Class<?>> services = new ArrayList<>();
        services.add(SwitchLanguagesTileService.class);
        return services;
    }
